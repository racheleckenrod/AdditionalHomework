...
// function multiplyThreeNumsAndRuturn(num1, num2, num3){
//     return num1 * num2 * num3
// }
...
//     let product = multiplyThreeNumsAndRuturn(5,10,2)
//     alert( '$' + product)
// }
...
//---Medium
//create a function that takes in three numbers. Add the first two 
// numbers and return the remainder of dividing the sum of 
